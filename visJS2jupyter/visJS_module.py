...
def visjs_network(nodes_dict, edges_dict,
                           ...
                           edge_width = 1, # width of all edges
						               edge_label_field = "id",
                           edge_width_field = None, #field that determines width of edges (overrides edge width setting)
    ...
    function runVis(visNodes, visEdges) {
       var vizOptions = {
		  ...
		  edges:{
            ...
            width: """+str('python_edges[i].'+edge_width_field if edge_width_field is not None else edge_width)+"""*"""+str(scaling_factor)+""",
		  },
		  interaction:{
